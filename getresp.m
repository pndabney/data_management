function varargout= getresp(network,station,location,channel,startdate,enddate,direc)
% [resp_query] = getresp(network,station,location,channel,startdate,enddate,direc)
%
...
% startdate        Start date [format: 'yyyy-mm-ddThh:mm:]
